...
namespace WinUI {
    ...
    public partial class PersonnelDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(int Id, string Name, string Position, decimal HourlyPay) {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([Id] = @Original_Id) AND ([Name] = @Original" +
                "_Name) AND ([Position] = @Original_Position) AND ([HourlyPay] = @Original_Hourly" +
                "Pay))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Id], [Name], [Position], [HourlyPay]) VALUES (@Id," +
                " @Name, @Position, @HourlyPay);\r\nSELECT Id, Name, Position, HourlyPay FROM Emplo" +
                "yee WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Id] = @Id, [Name] = @Name, [Position] = @Position, [HourlyPay] = @HourlyPay WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Position] = @Original_Position) AND ([HourlyPay] = @Original_HourlyPay));
SELECT Id, Name, Position, HourlyPay FROM Employee WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Position, HourlyPay FROM dbo.Employee";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, Name, Position, HourlyPay FROM dbo.Employee Where Name Like \'%\' + @val" +
                "ue + \'%\'";
